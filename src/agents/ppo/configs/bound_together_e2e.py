...
from src.envs.configs import bound_together_e2e
...
def get_training_config():
  ...
  # runner_config.policy_class_name = "ActorCriticRecurrent"
...
def get_config():
  ...
  config.env_class = jump_env_e2e.JumpEnv
  config.environment = bound_together_e2e.get_config()
  return config
