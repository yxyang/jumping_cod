    ...
    def __init__(
        ...
        if event_definition is None:  # means it wasn't specified by user
            if self.event_format == "LhBB":
                from third_party.pyPS4Controller.event_mapping.DefaultMapping import DefaultMapping
                self.event_definition = DefaultMapping
            else:
                from third_party.pyPS4Controller.event_mapping.Mapping3Bh2b import Mapping3Bh2b
